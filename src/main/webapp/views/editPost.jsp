	                    ...
	                    <form action="updatePost?id=${ id }" method="post" enctype="multipart/form-data">
	                    	<select name="categoryId" required="required" >
								...
								<c:forEach items="${categoryList}" var="c">
									<c:if test="${ post.categoryId == c.id }">
	                        ...
	                        <div class="row">
	                            <div class="col-md-6">
	                                <div class="form-group">
	                                    <label>Code</label>
	                                    <input type="text" class="form-control" name="code" value="${ post.code }" required="required"/>
	                                </div>
	                            </div>
	                            <div class="col-md-6">
	                                <div class="form-group">
	                                    <label>Image</label>
	                                    <input type="file" class="form-control" name="image" value="${ post.image }" required="required"/>
	                                </div>
	                            </div>
	                        </div>
